...
const Sidebar = () => {
  ...
  >
  <div className='flex items-center justify-between pu-6 border-b'>
  ...
  <div className=' flex w-full justify-between items-center'>
    ...
    {/*clear cart icon*/}
    <div onClick={clearCart} className='cursor-pointer py-4 bg-red-500 text-white w-12 h-12 flex justify-center items-centr text-xl'>
      <FiTrash2 />
      </div>
    </div>
  </div>
